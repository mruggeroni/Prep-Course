...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  return Object.assign(objeto, {[String(property)]: null})
}
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  const nuevoprecio = {
    nprecio: function() {
      var descuento;
      descuento = producto['porcentajeDeDescuento'] * producto['precio'];
      return (producto['precio'] - descuento)
    }
  }
  producto['calcularPrecioDescuento'] = nuevoprecio.nprecio;
  return producto
}
